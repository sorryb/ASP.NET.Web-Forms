<%@ Page language="c#" Inherits="BugsTrackers.Web.TimeEntry" CodeFile="DaylyActivities.aspx.cs" %>
						...
						<td vAlign="top" width="225">
							<table class="tan-border" style="WIDTH: 215px; HEIGHT: 47px" cellSpacing="12" cellPadding="0"
								...
								<tr>
									...
									<td><asp:textbox id="WeekEnding" runat="server" CssClass="standard-text" Width="68px"
