namespace BugsTrackers.Issues.UserControls
{
	...
	/// </summary>
	public partial class SubIssues : System.Web.UI.UserControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.PreRender += new System.EventHandler(this.SubIssues_PreRender);
		...
		// SubIssues.ascx
		//
		// This user control displays the Sub Issues tab on the IssueDetail.aspx
		// page.
		//
		//*********************************************************************
		...
		protected void SubIssues_PreRender(object sender, System.EventArgs e)
		{
