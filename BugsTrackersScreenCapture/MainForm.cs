...
namespace BugsTrackersScreenCapture
{
    ...
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            Color transparentYellowColor = Color.FromArgb(90, Color.Yellow);
            penYellowHighlighter = new Pen(transparentYellowColor, 14);
            ...
            MenuItem notifyIconHyphen = cm.MenuItems.Add("-");
        ...
        {
            // delay...
            System.Threading.Thread.Sleep(1000 * (int)numericUpDownDelay.Value);
        ...
        private void drawStrokes()
        {
            ...
            using (Graphics g = Graphics.FromImage(bitmapWithStrokes))
            {
                for (int i = 0; i < strokes.Count; i++)
                {
                    ...
                    {
                        g.DrawLines(penYellowHighlighter, stroke.points.ToArray());
                    }
                    else
                    {
                ...
                if (http_response_header != null)
                {
                    if (http_response_header.IndexOf("OK") == 0)
                    {
                        ...
                        DialogResult result = MessageBox.Show("Posted screenshot to Bug ID# "
                            ...
                            + Environment.NewLine
                            + Environment.NewLine
                            + "Go to the BugsTrackers  website?", "Bugs Trackers ", MessageBoxButtons.YesNo);
        ...
        //    sb.Append("&attachment_filename=screenshot.jpg");
        ...
        static void send(MainForm frm)
        {
            ...
            try
            {
                ...
                WebRequest req = extendedWebClient.Post(URL, new
                {
                    ...
                    attachment_filename = "screenshot.jpg",
                    attachment = base64
                });
